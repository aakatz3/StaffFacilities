...
/**
 * This is a stubbed, random-acting implementation of the exposed methods of the SFAPI section of StaffFacilities.
 * It exists to allow CI-style plugins to compile against StaffFacilities, and work at compile time.
 */

// Suppress warnings on this class
@SuppressWarnings({"ConstantConditions", "SameReturnValue", "unused"})
public class SFAPI {
